public class GameController {
    ...
    // Convenience constructor (two parameters)
    ...
    public static void main(String[] args) {
        ...
        GameController c2 = new GameController("Xbox Elite", "Bluetooth", true, 85, 2.5);

        // Controller with convenience constructor
        GameController c3 = new GameController("DualShock", "USB");
