public class SmartDevice {
    ...
    public static void main(String[] args) {
        ...
        SmartDevice d1 = new SmartDevice("Smart Bulb", "Living Room", false, 15.5);
        SmartDevice d2 = new SmartDevice("Smart Speaker", "Bedroom", true, 20.0);

        // Method chaining example
        d1.setOnline(true).connectToDevice("Alexa").rename("Main Bulb");
        d2.connectToDevice("TV").connectToDevice("Laptop");

        // Updates
        d1.updateLocation("Dining Room");
        d2.updatePowerConsumption(25.5);
